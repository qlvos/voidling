export const voidlingConfigCautious = {
    ...
    fillDensity: 0.7,       // How solid the voidling appears | Affects rendering performance | Higher = more solid appearance
    stepSize: 0.04,         // Granularity of render calculations | Affects smoothness and performance | Lower = smoother but slower
 
    // === MOVEMENT BEHAVIOR ===
    moveSpeed: 0.02,        // Base movement velocity | Multiplied by x/y bias | Higher = faster movement
    ...
    minMoveDistance: 50.0,  // Minimum single movement | Prevents tiny movements | Higher = forces longer movements
    xBias: 6.0,            // Horizontal movement preference | Multiplies moveSpeed for X axis | Higher = more horizontal movement
    yBias: 0.9,            // Vertical movement preference | Multiplies moveSpeed for Y axis | Higher = more vertical movement
    ...
    baseDeformStrength: 1.6,  // Base shape distortion | Affects overall flexibility | Higher = more base distortion
    ...
    deformComplexity: 1,      // Number of deformation waves | Affects detail level | Higher = more complex deformations
    deformSmoothness: 0.15,   // Smoothness of deformations | Affects transition speed | Higher = smoother but slower changes
    ...
    // === VISUAL EFFECTS ===
    perspectiveDistance: 70.0,  // Depth perception strength | Affects 3D appearance | Higher = more pronounced perspective
    ...
    minSkewness: 0.9,           // Minimum shape distortion | Sets base asymmetry | Higher = more base asymmetry
 
    // === BEHAVIOR CONTROL ===
    behaviorChangeTime: 100,    // Time between behavior switches | Controls behavior persistence | Higher = behaviors last longer
    behaviorWeight: 0.4         // Influence of behavior on movement | Affects decision strength | Higher = more committed to behaviors
 };